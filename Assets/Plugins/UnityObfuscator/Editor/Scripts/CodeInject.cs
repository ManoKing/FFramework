...
namespace Flower.UnityObfuscator
{
    internal class CodeInject : Obfuscator
    {
        ...
        protected override bool IsChangeField(TypeDefinition t, FieldDefinition f)
        {
            return false;
        }

        protected override bool IsChangeProperty(TypeDefinition t, PropertyDefinition p)
        {
            return false;
        }

        public void Obfuscate(AssemblyDefinition assembly, TypeDefinition garbageType)
        {
