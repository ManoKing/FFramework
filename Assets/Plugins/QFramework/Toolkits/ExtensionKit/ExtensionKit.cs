...
//            Log.E(">>>>>>>Error: Can\'t find Assembly-CSharp-Editor.dll");
    ...
    public static class RectTransformExtension
    {
        ...
        public static RectTransform SetSize(this RectTransform selfRectTrans, float sizeWidth, float sizeHeight)
        {
            selfRectTrans.sizeDelta = new Vector2(sizeWidth, sizeHeight);
            return selfRectTrans;
        }
