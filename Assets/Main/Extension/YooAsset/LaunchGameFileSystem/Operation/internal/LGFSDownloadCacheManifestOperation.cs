...
namespace YooAsset
{
    internal class LGFSDownloadCacheManifestOperation : AsyncOperationBase
    {
        private enum ESteps
        {
            None,
        ...
        internal LGFSDownloadCacheManifestOperation(LaunchGameFileSystem fileSystem, string packageVersion, string packageHash)
        {
