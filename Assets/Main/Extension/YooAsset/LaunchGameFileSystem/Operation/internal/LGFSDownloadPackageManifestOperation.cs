namespace YooAsset
{
    internal class LGFSDownloadPackageManifestOperation : AsyncOperationBase
    {
        private enum ESteps
        {
            None,
        ...
        internal LGFSDownloadPackageManifestOperation(LaunchGameFileSystem fileSystem, string packageVersion, string packageHash)
        {
        ...
        internal override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.RequestFileData)
            {
                ...
                {
                    string filePath = _fileSystem.GetPackageManifestFilePath(_packageVersion);
