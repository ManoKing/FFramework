...
namespace QFramework
{
    public class UICreateService
    {
        ...
        {
            string dirPath = Application.dataPath + "/Plugins/QFramework/QFrameworkData/UI/Resources";
            string filePath = dirPath + "/UIRoot.prefab";
            Debug.Log(dirPath);
            if (!Directory.Exists(dirPath)) Directory.CreateDirectory(dirPath);
            bool isSuccess = false;
            PrefabUtility.SaveAsPrefabAsset(UIManagerGo, filePath, out isSuccess);
        }
    }
}